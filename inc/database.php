...
function vln_wines_createdatabase()
{
  ...
  `bottle_price_en` VARCHAR(10) DEFAULT NULL,
  `bottle_price_es` VARCHAR(10) DEFAULT NULL,
  `box_price_en` VARCHAR(10) DEFAULT NULL,
  `box_price_es` VARCHAR(10) DEFAULT NULL,
