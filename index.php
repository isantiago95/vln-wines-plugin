...
// var_dump(str_replace('/?lang=en', '',home_url('/wp-json')));

/**
 * Loading Necessary Scripts
 */
add_action( 'admin_enqueue_scripts', 'VLN_react_scripts' );
add_action('wp_enqueue_scripts', 'VLN_react_scripts' );
function VLN_react_scripts() {
    ...
    wp_localize_script( 'vln-wines-plugin', 'appLocalizer', [
        'apiUrl' => str_replace('/?lang=en', '',home_url('/wp-json')),
...
/* Adding shortcode */
require VLN_PATH.'inc/shortcode.php';